...
3. チャットからの画像生成（SD-Link）機能は、AIが「ユーザーの指示をStable Diffusion用の英語プロンプトに翻訳して出力する」ことで実現しています。
...
※ただしMistralの場合、Agents機能が有効になっていると、Agents機能での画像生成が優先されてしまう可能性があります。MistralでSD-Linkを使用されるときは、Agents機能のチェックボックスをオフにしておいてください。  
